...
namespace Com.Coinbase.Api.Entity {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.coinbase.api.entity']/class[@name='TransferNode']"
	[global::Android.Runtime.Register ("com/coinbase/api/entity/TransferNode", DoNotGenerateAcw=true)]
	public partial class TransferNode : global::Java.Lang.Object, global::Java.IO.ISerializable {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/coinbase/api/entity/TransferNode", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (TransferNode); }
		}

		protected TransferNode (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.coinbase.api.entity']/class[@name='TransferNode']/constructor[@name='TransferNode' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe TransferNode ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (TransferNode)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Coinbase.Api.Entity.TransferNode __this = global::Java.Lang.Object.GetObject<global::Com.Coinbase.Api.Entity.TransferNode> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Coinbase.Api.Entity.Transfer Transfer {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.coinbase.api.entity']/class[@name='TransferNode']/method[@name='getTransfer' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.coinbase.api.entity']/class[@name='TransferNode']/method[@name='setTransfer' and count(parameter)=1 and parameter[1][@type='com.coinbase.api.entity.Transfer']]"
