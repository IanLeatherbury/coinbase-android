...
namespace Com.Coinbase.Api.Entity {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.coinbase.api.entity']/class[@name='OrderResponse']"
	[global::Android.Runtime.Register ("com/coinbase/api/entity/OrderResponse", DoNotGenerateAcw=true)]
	public partial class OrderResponse : global::Com.Coinbase.Api.Entity.Response {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/coinbase/api/entity/OrderResponse", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (OrderResponse); }
		}

		protected OrderResponse (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.coinbase.api.entity']/class[@name='OrderResponse']/constructor[@name='OrderResponse' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe OrderResponse ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (OrderResponse)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Coinbase.Api.Entity.OrderResponse __this = global::Java.Lang.Object.GetObject<global::Com.Coinbase.Api.Entity.OrderResponse> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Coinbase.Api.Entity.Order Order {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.coinbase.api.entity']/class[@name='OrderResponse']/method[@name='getOrder' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.coinbase.api.entity']/class[@name='OrderResponse']/method[@name='setOrder' and count(parameter)=1 and parameter[1][@type='com.coinbase.api.entity.Order']]"
