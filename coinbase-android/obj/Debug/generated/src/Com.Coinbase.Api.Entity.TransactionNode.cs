...
namespace Com.Coinbase.Api.Entity {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.coinbase.api.entity']/class[@name='TransactionNode']"
	[global::Android.Runtime.Register ("com/coinbase/api/entity/TransactionNode", DoNotGenerateAcw=true)]
	public partial class TransactionNode : global::Java.Lang.Object, global::Java.IO.ISerializable {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/coinbase/api/entity/TransactionNode", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (TransactionNode); }
		}

		protected TransactionNode (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.coinbase.api.entity']/class[@name='TransactionNode']/constructor[@name='TransactionNode' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe TransactionNode ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (TransactionNode)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Coinbase.Api.Entity.TransactionNode __this = global::Java.Lang.Object.GetObject<global::Com.Coinbase.Api.Entity.TransactionNode> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Coinbase.Api.Entity.Transaction Transaction {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.coinbase.api.entity']/class[@name='TransactionNode']/method[@name='getTransaction' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.coinbase.api.entity']/class[@name='TransactionNode']/method[@name='setTransaction' and count(parameter)=1 and parameter[1][@type='com.coinbase.api.entity.Transaction']]"
