...
namespace Com.Coinbase.Api.Entity {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.coinbase.api.entity']/class[@name='RecurringPaymentResponse']"
	[global::Android.Runtime.Register ("com/coinbase/api/entity/RecurringPaymentResponse", DoNotGenerateAcw=true)]
	public partial class RecurringPaymentResponse : global::Com.Coinbase.Api.Entity.Response {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/coinbase/api/entity/RecurringPaymentResponse", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (RecurringPaymentResponse); }
		}

		protected RecurringPaymentResponse (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.coinbase.api.entity']/class[@name='RecurringPaymentResponse']/constructor[@name='RecurringPaymentResponse' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe RecurringPaymentResponse ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (RecurringPaymentResponse)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Coinbase.Api.Entity.RecurringPaymentResponse __this = global::Java.Lang.Object.GetObject<global::Com.Coinbase.Api.Entity.RecurringPaymentResponse> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Coinbase.Api.Entity.RecurringPayment RecurringPayment {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.coinbase.api.entity']/class[@name='RecurringPaymentResponse']/method[@name='getRecurringPayment' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.coinbase.api.entity']/class[@name='RecurringPaymentResponse']/method[@name='setRecurringPayment' and count(parameter)=1 and parameter[1][@type='com.coinbase.api.entity.RecurringPayment']]"
